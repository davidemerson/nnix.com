...
The source keeps a calibrated table of what each option costs. Mine is 6,392 bytes of flash, measured by building package 4 twice with the option on and off.
...
So I did not reuse it. A two point central difference at h = max(|x|,1) × 10⁻¹¹ measures 22.6 digits using two evaluations instead of fifteen. Nearly three decades better for an eighth of the work. The sophistication was in the wrong place: the step decides whether the stencil matters at all.
